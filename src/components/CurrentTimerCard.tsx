          ...
          <HelpDot
            ...
            content={
              <HelpList
                title="진행하면서"
                items={[
                  "일시정지는 남은 시간을 그대로 두고 멈춰요.",
                  "리셋은 지금 세션을 처음 길이로 되돌려요. 정지는 세션 선택까지 풀어요.",
                  "가감 버튼은 진행 중에도 바로 반영돼요.",
                  "이전, 다음을 누르면 세션이 바뀌어요. 돌아가던 중이었다면 바뀐 세션이 곧바로 시작돼요.",
                  "종료 안내 시점이 되면 뷰어가 노란색으로, 0이 되면 빨간색으로 바뀌고 초과 시간이 올라가요.",
                ]}
              />
            }
          />
