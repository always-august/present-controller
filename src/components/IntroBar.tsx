...
export function IntroBar() {
  ...
  return (
    <div className="mx-4 flex flex-wrap items-center gap-x-5 gap-y-2 rounded-xl border border-line bg-panel px-4 py-3 text-xs text-subtext shadow-[var(--shadow-card)]">
      ...
      <span className="flex items-center">
        ...
        <HelpDot
          ...
          content={
            <HelpList
              items={[
                <><b>뷰어</b>는 발표자가 보는 화면이에요. 무대 모니터나 태블릿에 띄워 주세요.</>,
                <><b>컨트롤러</b>는 지금 이 화면이에요. 타이머, 재생, 메시지, 설정을 다뤄요.</>,
                <><b>오퍼레이터</b>에는 시작, 일시정지, 이전, 다음, 시간 가감만 있어요.</>,
                <><b>모더레이터</b>는 메시지만 보내요.</>,
                <><b>아젠다</b>는 전체 순서와 진행 위치를 보여줘요.</>,
                <><b>청중 질문</b>은 청중이 질문을 보내는 폼이에요.</>,
              ]}
            />
          }
        />
      ...
      <span>링크를 아는 사람은 누구나 뷰어를 볼 수 있어요. 비밀키가 붙은 링크는 운영자끼리만 주고받으세요.</span>
      <span>24시간 동안 아무도 쓰지 않은 방은 지워져요.</span>
